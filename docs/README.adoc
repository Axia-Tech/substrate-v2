...
https://github.com/Axia-Tech/substrate-v2/blob/master/core/primitives/src/crypto.rs#L767[here], but the
...
https://github.com/Axia-Tech/substrate-v2/blob/master/LICENSE[LICENSE]
