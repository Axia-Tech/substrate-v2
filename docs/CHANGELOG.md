...
If that doesn't work for you, we are working on an in-depth-guide for all major changes that took place and how you need to adapt your code for it. [You can find the upgrade guide under `docs/` in the repo](https://github.com/Axia-Tech/substrate-v2/blob/master/docs/Upgrading-2.0-to-3.0.md), if you have further questions or problem, please [feel free to ask in the github discussion board](https://github.com/Axia-Tech/substrate-v2/discussions).
...
* [#7381: Make Substrate compile with latest nightly](https://github.com/Axia-Tech/substrate-v2/pull/7381)
* [#7238: Fix compilation with environmental on latest nightly](https://github.com/Axia-Tech/substrate-v2/pull/7238)
* [#7395: Make benchmarks compile with latest nightly](https://github.com/Axia-Tech/substrate-v2/pull/7395)
* [#7838: Fix incorrect use of syn::exports](https://github.com/Axia-Tech/substrate-v2/pull/7838) (partially)
* [#7854: Update to futures 0.3.9](https://github.com/Axia-Tech/substrate-v2/pull/7854)
